	...
	<?php include "nav_about.php"; ?>
			...
			<div id="main">
				...
				<p>
					<strong>David Bamman</strong>, Tufts University<br />
					“Large-Scale Text Analysis: Measuring Latin Variation in a Million Books.”<br />
					April 8, 2011.
				</p>
				<p>
					<strong>Chris Forstall</strong>, University at Buffalo<br />
					“Designing Intertextual Search.”<br />
					March 3, 2011.
				</p>
				

				<h3>Lecture Series 2009–2010</h3>
				
				<p>
					<strong>Neil Coffee</strong> and <strong>Susan Cole</strong>, University at Buffalo<br />
					“Lucan's Vergil and Dionysiac Inscriptions: Results from the DHIB Textual Analysis Working Group.”<br />
					April 23, 2010.
				</p>
				<p>
					<strong>Neel Smith</strong>, College of the Holy Cross<br />
					“Digital Vellum: reading and editing digital texts.”<br />
					April 16, 2010.
				</p>
				<p>
					<strong>Walter Scheirer</strong>, University of Colorado at Colorado Springs<br />
					“Commercial and Humanities Text Mining: Revealing Technique in Ancient Greek Literature.”<br />
					April 1, 2010.
				</p>
