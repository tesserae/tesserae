...
<?php include "nav_search.php"; ?>
		...
		<div id="main">
			...
			<form action="<?php echo $url_cgi.'/read_table.pl'; ?>" method="post" ID="Form1">
				...
				<p>
					An experimental featureset that allows you to search Latin allusions to Greek sources.
				</p>
				<p>
				...
				<table class = "input">
					...
					<tr>
						...
						<td>
							<select name="feature">
								<option value="trans1" disabled="disabled">Parallel Texts Method</option>
								<option value="trans">Dictionary Method</option>
							</select>
						</td>
					</tr>
					<tr>
