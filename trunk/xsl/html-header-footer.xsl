...
<xsl:variable name="url_cgi" select="'http://ahmik/~chris/tess.orig/cgi-bin'"/><!-- URL_CGI -->
<xsl:variable name="url_css" select="'http://ahmik/~chris/tess.orig/css'"/><!-- URL_CSS -->
<xsl:variable name="url_html" select="'http://ahmik/~chris/tess.orig/html'"/><!-- URL_HTML -->
<xsl:variable name="url_image" select="'http://ahmik/~chris/tess.orig/images'"/><!-- URL_IMAGE -->
